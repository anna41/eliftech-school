...
@font-face {
      ...
      src: url('./font/social-login-font.eot?65336558');
      src: url('./font/social-login-font.eot?65336558#iefix') format('embedded-opentype'),
           url('./font/social-login-font.woff?65336558') format('woff'),
           url('./font/social-login-font.ttf?65336558') format('truetype'),
           url('./font/social-login-font.svg?65336558#social-login-font') format('svg');
      font-weight: normal;
      font-style: normal;
    }
    ...
    <link rel="stylesheet" href="css/animation.css"><!--[if IE 7]><link rel="stylesheet" href="css/social-login-font-ie7.css"><![endif]-->
    <script>
  ...
  <body>
    ...
    <div id="icons" class="container">
      ...
      <div class="row">
        <div title="Code: 0xf270" class="the-icons span3"><i class="demo-icon icon-amazon">&#xf270;</i> <span class="i-name">icon-amazon</span><span class="i-code">0xf270</span></div>
      </div>
    </div>

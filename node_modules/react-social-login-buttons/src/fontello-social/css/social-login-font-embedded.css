...
@media screen and (-webkit-min-device-pixel-ratio:0) {
  @font-face {
    font-family: 'social-login-font';
    src: url('../font/social-login-font.svg?75865202#social-login-font') format('svg');
  }
}
*/
